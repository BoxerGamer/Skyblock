...
import me.boxergamerpw.spacehelmet.SpaceHelmetCmd;
...
public class SpaceHelmet extends JavaPlugin {

    @Override
    public void onEnable() {

        getCommand("shelmet").setExecutor(new SpaceHelmetCmd());
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                for (Player player : Bukkit.getOnlinePlayers()) {
                    ...
                    if (ItemName.equals(ChatColor.RED + "Boxer's Space Helmet")) {
                        Random r = new Random();
